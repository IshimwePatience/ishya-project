      ...
      <div className="w-full max-w-sm text-center">
        ...
        <form onSubmit={handleVerify} className="space-y-8">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-white text-black font-medium rounded-full hover:bg-brown hover:text-white transition-all duration-300 flex items-center justify-center gap-2 shadow-2xl text-sm group"
          >
