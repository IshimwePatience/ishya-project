            ...
            >
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    type="email"
                    className="w-full bg-[#1c1c1c] border border-white/10 rounded-full px-4 py-3 focus:outline-none focus:border-primary transition-all text-white placeholder-gray-600"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-[#1c1c1c] border border-white/10 rounded-full px-4 py-3 focus:outline-none focus:border-primary transition-all pr-12 text-white placeholder-gray-600"
                      placeholder="••••••••"
                      value={password}
