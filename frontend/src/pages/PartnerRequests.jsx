  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-4 border-b border-white/5 pb-6">
        <div>
          <h2 className="text-2xl font-bold text-white tracking-tight">Partner Requests</h2>
          <p className="text-sm text-white/40 mt-1">Review and manage incoming partnership applications</p>
        </div>
