...
const PublicEvents = ({ isDashboard }) => {
  ...
  return (
    <div className={`min-h-screen bg-theme-bg text-theme-text font-sans selection:bg-theme-text selection:text-theme-bg ${isDashboard ? 'rounded-lg overflow-hidden' : ''}`}>
                    ...
                    <div className="bg-theme-surface border border-theme-border rounded-lg overflow-hidden flex flex-col shadow-2xl">
                      ...
                      <div className="p-6 flex flex-col gap-4">
                        <div>
                          ...
                          <p className="text-[13px] text-theme-text-muted-dark flex items-center gap-1.5 mt-2">
                        ...
                        <div className="flex items-center justify-between border-t border-theme-border-light pt-4 mt-2">
                          <div className="flex flex-col">
                            ...
                            <span className="text-[12px] text-theme-text-muted-dark flex items-center gap-1 mt-0.5 font-medium">
                          ...
                          <button 
                            ...
                            className="px-6 py-2.5 bg-theme-text text-theme-bg font-bold text-[13px] hover:opacity-90 transition-all rounded-full shadow-lg active:scale-95 whitespace-nowrap"
                          >
                            Book Ticket
                          </button>
                        </div>
                  ...
                  <div className="bg-theme-surface border border-theme-border rounded-lg overflow-hidden flex flex-col shadow-2xl relative">
                    ...
                    <div className="flex items-center px-6 py-3 border-b border-theme-border bg-theme-input-bg gap-4">
                      ...
                      <input 
                        ...
                        className="bg-transparent border-none outline-none text-[13px] text-theme-text w-full placeholder:text-theme-text-muted-dark font-medium"
                        value={searchQuery}
                    ...
                    <div className="overflow-x-auto w-full">
                      <div className="min-w-[650px]">
                        <div className="grid grid-cols-[3fr_1fr_1.5fr_1fr] gap-4 px-6 py-3 border-b border-theme-border text-[12px] font-bold text-theme-text-muted-dark">
                      <div>Event</div>
                      <div>Status</div>
                          ...
                          <div key={event.id} className="group grid grid-cols-[3fr_1fr_1.5fr_1fr] gap-4 px-6 py-4 border-b border-theme-border-light hover:bg-theme-input-bg-hover transition-colors items-center">
                            ...
                            <div className="flex items-center gap-4 pr-4 overflow-hidden">
                              ...
                              <div className="flex flex-col min-w-0">
                                ...
                                <p className="text-[12px] text-theme-text-muted-dark truncate w-full mt-1 flex items-center gap-1">
                            ...
                            <div className="flex flex-col justify-center">
                               ...
                               <span className="text-[12px] text-theme-text-muted-dark flex items-center gap-1 mt-0.5">
                            ...
                            <div className="text-right">
                              <button 
                                ...
                                className="px-4 py-2 bg-theme-text text-theme-bg font-bold text-[12px] hover:opacity-90 transition-all rounded-sm shadow-md active:scale-95 whitespace-nowrap"
                              >
                                Book Ticket
                              </button>
                            </div>
          ...
          <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 md:p-6 bg-black/90 backdrop-blur-md overflow-hidden">
            ...
            >
              ...
              <button
                type="button"
                onClick={() => setBookingShow(null)}
                className="absolute top-4 right-4 z-30 text-theme-text-muted hover:text-theme-text transition-colors border-none bg-theme-surface/80 hover:bg-theme-input-bg-hover w-8 h-8 rounded-full flex items-center justify-center cursor-pointer text-sm"
              >
                ✕
              </button>
              ...
              <div className="flex-1 h-full flex flex-col min-h-0 bg-theme-surface text-left">
                  ...
                  {bookingSuccess && ticketDetails ? (
                    ...
                    <div className="space-y-6 py-4 text-center max-w-md mx-auto">
                      ...
                      <div className="border border-theme-border rounded-sm bg-theme-surface overflow-hidden shadow-2xl text-left relative font-mono">
                        {/* Golden header */}
                        <div className="bg-theme-text text-theme-bg px-4 py-2 text-[10px] font-black uppercase tracking-widest flex justify-between items-center font-sans">
                      ...
                      <button
                        type="button"
                        onClick={() => setBookingShow(null)}
                        className="w-full py-3 bg-theme-surface border border-theme-border text-theme-text hover:bg-theme-input-bg text-xs font-bold rounded-sm transition-colors cursor-pointer uppercase tracking-wider font-sans"
                      >
                        Close & Finish
                      </button>
                    </div>
                    ...
                    <form onSubmit={handleFreeBooking} className="space-y-6">
                      <div className="space-y-4">
                        <div className="space-y-1">
                          ...
                          <input
                            type="text"
                            required
                            className="w-full bg-theme-input-bg border border-theme-border rounded-sm px-4 py-3 focus:border-theme-accent outline-none text-theme-text text-xs font-sans"
                          ...
                          <div className="flex gap-2">
                            <input
                              ...
                              className={`flex-1 bg-theme-input-bg border rounded-sm px-4 py-3 outline-none text-theme-text text-xs font-sans transition-colors ${
                                otpVerified ? 'border-green-500/50 opacity-60' : 'border-theme-border focus:border-theme-accent'
                              }`}
                            ...
                            {!otpVerified && (
                              <button
                                ...
                                className="px-4 py-3 bg-theme-text text-theme-bg text-[10px] font-black uppercase tracking-wider rounded-sm hover:bg-[white] disabled:opacity-30 transition-all whitespace-nowrap cursor-pointer"
                              >
                        ...
                        {otpSent && !otpVerified && (
                          <motion.div
                            ...
                            className="space-y-2 p-4 bg-theme-input-bg border border-theme-accent/20 rounded-sm"
                          >
                            ...
                            <div className="flex gap-2">
                              <input
                                ...
                                className="flex-1 bg-theme-input-bg border border-theme-border rounded-sm px-4 py-3 text-theme-text text-sm font-mono font-bold tracking-[0.5em] focus:border-theme-accent outline-none text-center"
                              />
                              <button
                                type="button"
                                disabled={otpCode.length < 6 || otpLoading}
                                onClick={handleVerifyOTP}
                                className="px-5 py-3 bg-theme-text text-theme-bg text-[10px] font-black uppercase tracking-wider rounded-sm hover:opacity-90 disabled:opacity-30 transition-all cursor-pointer"
                              >
                                {otpLoading ? '...' : 'Confirm'}
                              </button>
                            </div>
                        ...
                        <div className="space-y-2 pt-2">
                          ...
                          <div className="flex items-center gap-3">
                            <button
                              ...
                              className="w-10 h-10 bg-theme-surface border border-theme-border rounded-sm flex items-center justify-center text-theme-text hover:bg-theme-input-bg text-lg cursor-pointer transition-colors"
                            >
                              -
                            </button>
                      ...
                      <div className="p-4 bg-theme-surface border border-theme-border-light rounded-sm flex justify-between items-center text-xs font-sans">
                      ...
                      {totalBookingAmount > 0 ? (
                        ...
                        <div className="space-y-4">
                          {(!buyerName || !buyerEmail || !otpVerified) ? (
                            <div className="p-3 bg-theme-surface border border-theme-border-light text-center text-[11px] text-theme-text-muted font-medium rounded-sm font-sans">
                            ...
                            <div className="space-y-2 animate-in fade-in duration-300">
                              ...
                              <button
                                type="button"
                                onClick={() => setBookingShow(null)}
                                className="w-full py-3 mt-3 bg-theme-surface border border-theme-border hover:bg-theme-input-bg text-theme-text text-xs font-bold rounded-sm transition-colors cursor-pointer text-center uppercase tracking-wider block"
                              >
                                Cancel Checkout
                              </button>
                            </div>
                        ...
                        <button
                          ...
                          className="w-full py-3 bg-[white] hover:bg-theme-text text-theme-bg font-black text-xs uppercase tracking-wider rounded-sm transition-colors cursor-pointer disabled:opacity-30 font-sans"
                        >
