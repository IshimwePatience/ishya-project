...
const PartnerRegistration = () => {
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center p-6">
        <motion.div 
          ...
          className="max-w-md w-full bg-[#111] border border-white/5 rounded-sm p-10 text-center space-y-6"
        >
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col md:flex-row">
      {/* Sidebar Info */}
      <div className="w-full md:w-[40%] bg-[#111] border-r border-white/5 p-12 flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="flex-1 p-12 overflow-y-auto">
        <div className="max-w-2xl mx-auto space-y-10 py-10">
          <div className="space-y-2">
            ...
            <p className="text-gray-400 text-sm">Tell us about your organization to get started.</p>
          </div>

          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2 col-span-2 md:col-span-1">
              <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Organization Name</label>
            ...
            <div className="space-y-2 col-span-2 md:col-span-1">
              <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Partner Type</label>
              <select 
                name="type"
                value={formData.type}
                onChange={handleChange}
            ...
            <div className="space-y-2 col-span-2 md:col-span-1">
              <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Contact Person</label>
              <div className="relative">
            ...
            <div className="space-y-2 col-span-2 md:col-span-1">
              <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Work Email</label>
              <div className="relative">
            ...
            <div className="space-y-2 col-span-2 md:col-span-1">
              <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Location / Address</label>
              <div className="relative">
            ...
            <div className="space-y-2 col-span-2">
              <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Additional Notes (Optional)</label>
              <textarea 
                name="message"
