      ...
      {isOpen && (
        ...
        >
          <div className="flex justify-between items-center mb-12">
            ...
            <Link to="/" className="text-xl md:text-2xl font-black tracking-tighter">Ishya <span className="text-gray-500">Studios</span></Link>
    ...
    <>
      ...
      <nav
          className={`fixed top-0 left-0 right-0 z-[150] h-20 md:h-24 px-6 md:px-20 flex items-center justify-between transition-all duration-700 ${isVisible
            ? "bg-black/90 backdrop-blur-xl border-b-0"
      ...
      >
        <div className="flex items-center gap-10">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <Link to="/" className={`text-sm transition-colors ${location.pathname === '/' ? 'text-white' : 'text-gray-400 hover:text-white'}`} style={{ fontFamily: 'Lato, sans-serif', fontWeight: 'bold' }}>Catalog</Link>
            <Link to="/events" className={`text-sm transition-colors ${location.pathname === '/events' ? 'text-white' : 'text-gray-400 hover:text-white'}`} style={{ fontFamily: 'Lato, sans-serif', fontWeight: 'bold' }}>Events</Link>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <Link
            to="/login"
            className="hidden md:flex px-6 py-3 border border-white/10 hover:border-white rounded-sm text-sm transition-all bg-white/5 backdrop-blur-md items-center gap-3 group"
            style={{ fontFamily: 'Lato, sans-serif', fontWeight: 'bold' }}
          >
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-6">
              <Link to="/" className="text-4xl transition-colors text-gray-400 hover:text-white" style={{ fontFamily: 'Lato, sans-serif', fontWeight: 'bold' }}>Catalog</Link>
              <Link to="/events" className="text-4xl transition-colors text-gray-400 hover:text-white" style={{ fontFamily: 'Lato, sans-serif', fontWeight: 'bold' }}>Events</Link>
              <a href="#" className="text-4xl transition-colors text-gray-400 hover:text-white" style={{ fontFamily: 'Lato, sans-serif', fontWeight: 'bold' }}>About</a>
            ...
            <div className="absolute bottom-10 left-6 right-6">
              <div className="text-[10px] font-black uppercase tracking-[0.5em] text-gray-500 italic">Ishya Studios • 2026</div>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
